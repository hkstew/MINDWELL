...
class BadReasonPage extends StatefulWidget {
  const BadReasonPage({
    super.key,
  ...
  @override
  State<BadReasonPage> createState() => _BadReasonPageState();
}

class _BadReasonPageState extends State<BadReasonPage> {
  bool _second = false;
  Timer? _timer;
    ...
    Navigator.of(context).pushReplacement(
      PageRouteBuilder(
        pageBuilder: (_, __, ___) => FinalIntroPage(
          // ✅ ส่งข้อความ + ชนิดอารมณ์ไปหน้า FinalIntroPage
          reasonText: text,
          emotion: EmotionType.bad,
        ),

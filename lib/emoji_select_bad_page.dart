...
class EmojiSelectBadPage extends StatefulWidget {
  const EmojiSelectBadPage({super.key});

  @override
  State<EmojiSelectBadPage> createState() => _EmojiSelectBadPageState();
}

class _EmojiSelectBadPageState extends State<EmojiSelectBadPage> {
  ...
  // จังหวะสลับ (ให้ mood หน่วงกว่านิด ๆ เพื่อความรู้สึกหนักขึ้น)
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.of(context).push(_badRoute(
                          const BadReasonPage(
...
Route _badRoute(Widget page) {
  return PageRouteBuilder(
    // ✅ ต้องมี param นี้เสมอ

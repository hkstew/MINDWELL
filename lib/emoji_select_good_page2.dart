...
class EmojiSelectGoodPage2 extends StatefulWidget {
  const EmojiSelectGoodPage2({super.key});

  @override
  State<EmojiSelectGoodPage2> createState() => _EmojiSelectGoodPageState();
}

class _EmojiSelectGoodPageState extends State<EmojiSelectGoodPage2> {
            ...
            Align(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    // อิโมจิบนกลาง (อารมณ์ดี)
                    GestureDetector(
                      onTap: () => _openGoodReasonPage(
...
Route<Map<String, dynamic>> _goodRoute(Widget page) {
